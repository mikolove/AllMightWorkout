...
class AmwAppState(
    ...
    fun navigateToTopLevelDestination(topLevelDestination: TopLevelDestination) {
        ...
        when (topLevelDestination) {
            ...
            /*TopLevelDestination.WORKOUTS -> navController.navigateToHome(topLevelNavOptions)
            TopLevelDestination.EXERCISES -> navController.navigateToHome(topLevelNavOptions)*/
        }
    }
