                ...
                WorkInfo.State.SUCCEEDED ->{
                    appendToMessageQueue(
                        GenericMessageInfo.Builder()
                            ...
                            .title(com.mikolove.core.interactors.sync.SyncEverything.SYNC_EV_SUCCESS_TITLE)
                            .description(com.mikolove.core.interactors.sync.SyncEverything.SYNC_EV_SUCCESS_DESCRIPTION)
                ...
                WorkInfo.State.FAILED ->{
                    appendToMessageQueue(
                        GenericMessageInfo.Builder()
                            ...
                            .title(com.mikolove.core.interactors.sync.SyncEverything.SYNC_GERROR_TITLE)
                            .description(com.mikolove.core.interactors.sync.SyncEverything.SYNC_GERROR_DESCRIPTION)
