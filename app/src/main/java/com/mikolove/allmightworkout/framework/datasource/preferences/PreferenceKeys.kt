...
/*
        val WORKOUT_TRAINING_LIST_FILTER: String = "${WORKOUT_LIST_PREFERENCES}.WORKOUT_TRAINING_LIST_FILTER"
        val WORKOUT_TRAINING_LIST_ORDER: String = "${WORKOUT_LIST_PREFERENCES}.WORKOUT_TRAINING_LIST_ORDER"
