...
class GetWorkouts(
    ...
    fun getWorkouts(
        ...
        val response = object : CacheResponseHandler<WorkoutViewState,List<Workout>>(
            response = cacheResult,
            stateEvent = stateEvent
        ){
            override suspend fun handleSuccess(resultObj: List<Workout>): DataState<WorkoutViewState>? {
                ...
                return DataState.data(
                    ...
                    data = WorkoutViewState(listWorkouts = ArrayList(resultObj)),
                    stateEvent = stateEvent
                )
            }
        }.getResult()
