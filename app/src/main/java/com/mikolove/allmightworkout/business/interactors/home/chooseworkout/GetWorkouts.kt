...
class GetWorkouts(
    ...
    fun getWorkouts(
        ...
        val response = object : CacheResponseHandler<ChooseWorkoutViewState,List<Workout>>(
            response = cacheResult,
            stateEvent = stateEvent
        ){
            override suspend fun handleSuccess(resultObj: List<Workout>): DataState<ChooseWorkoutViewState>? {
                ...
                return DataState.data(
                    ...
                    data = ChooseWorkoutViewState(workoutList = ArrayList(resultObj)),
                    stateEvent = stateEvent
                )
            }
        }.getResult()
