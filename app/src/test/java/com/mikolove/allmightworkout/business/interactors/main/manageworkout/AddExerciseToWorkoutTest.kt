...
/*
Test cases:
1. addExerciseWorkout_success_confirmNetworkAndCacheUpdated()
...
2. addExerciseWorkout_fail_confirmNetworkAndCacheUnchanged()
    a) add a new Exercise into a workout
...
class AddExerciseToWorkoutTest {
    ...
    @Test
    fun addExerciseWorkout_success_confirmNetworkAndCacheUpdated() = runBlocking {
    ...
    @Test
    fun addExerciseWorkout_fail_confirmNetworkAndCacheUnchanged() = runBlocking {
