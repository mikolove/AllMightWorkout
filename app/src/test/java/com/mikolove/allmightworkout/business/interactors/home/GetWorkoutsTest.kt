...
import com.mikolove.allmightworkout.business.interactors.home.chooseworkout.GetWorkouts
import com.mikolove.allmightworkout.business.interactors.home.chooseworkout.GetWorkouts.Companion.GET_WORKOUTS_NO_MATCHING_RESULTS
import com.mikolove.allmightworkout.business.interactors.home.chooseworkout.GetWorkouts.Companion.GET_WORKOUTS_SUCCESS
import com.mikolove.allmightworkout.di.DependencyContainer
import com.mikolove.allmightworkout.framework.datasource.database.WORKOUT_ORDER_BY_ASC_DATE_UPDATED
import com.mikolove.allmightworkout.framework.presentation.home.chooseworkout.state.ChooseWorkoutStateEvent.GetWorkoutsEvent
    ...
    fun blankQuery_success_confirmNWorkoutsRetrieved() = runBlocking {
        ...
        getWorkouts.getWorkouts(
            ...
            override suspend fun emit(value: DataState<ChooseWorkoutViewState>?) {
                ...
                value?.data?.workoutList?.let { list ->
